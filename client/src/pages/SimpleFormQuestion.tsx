...
import { AnswerModeProvider, useAnswerMode } from "../context/AnswerModeContext";
...
const SimpleFormQuestionContent = () => {
  ...
  return (
    ...
    >
        <Grid2
          size={answerMode ? 8 : 3} sx={{ height: "100%", transition: "width 0.5s ease"}}
        >
        ...
        <Grid2
          size={answerMode ? 3 : 9} sx={{ height: "100%", transition: "width 0.5s ease"}}
        >
          <Box className="grid-column">
            <SimpleViewer />
          </Box>
